...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { nblk_strm1_din { O 64 vector } nblk_strm1_full_n { I 1 bit } nblk_strm1_write { O 1 bit } nblk_strm1_num_data_valid { I 32 vector } nblk_strm1_fifo_cap { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { nblk_strm2_din { O 64 vector } nblk_strm2_full_n { I 1 bit } nblk_strm2_write { O 1 bit } nblk_strm2_num_data_valid { I 32 vector } nblk_strm2_fifo_cap { I 32 vector } } \
} "
}
