...
set Spec2ImplPortList { 
	...
	nblk_strm1 { ap_fifo {  { nblk_strm1_din fifo_data_in 1 64 }  { nblk_strm1_full_n fifo_status 0 1 }  { nblk_strm1_write fifo_port_we 1 1 }  { nblk_strm1_num_data_valid fifo_status_num_data_valid 0 32 }  { nblk_strm1_fifo_cap fifo_update 0 32 } } }
	...
	nblk_strm2 { ap_fifo {  { nblk_strm2_din fifo_data_in 1 64 }  { nblk_strm2_full_n fifo_status 0 1 }  { nblk_strm2_write fifo_port_we 1 1 }  { nblk_strm2_num_data_valid fifo_status_num_data_valid 0 32 }  { nblk_strm2_fifo_cap fifo_update 0 32 } } }
