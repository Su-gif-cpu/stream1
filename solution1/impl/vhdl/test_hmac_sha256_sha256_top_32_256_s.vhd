...
attribute shreg_extract : string;
    ...
    signal dup_strm_U0_nblk_strm1_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_nblk_strm1_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_end_nblk_strm1_din : STD_LOGIC_VECTOR (0 downto 0);
    signal dup_strm_U0_end_nblk_strm1_write : STD_LOGIC;
    signal dup_strm_U0_end_nblk_strm1_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_end_nblk_strm1_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_nblk_strm2_din : STD_LOGIC_VECTOR (63 downto 0);
    signal dup_strm_U0_nblk_strm2_write : STD_LOGIC;
    signal dup_strm_U0_nblk_strm2_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_nblk_strm2_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_end_nblk_strm2_din : STD_LOGIC_VECTOR (0 downto 0);
    signal dup_strm_U0_end_nblk_strm2_write : STD_LOGIC;
    signal dup_strm_U0_end_nblk_strm2_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal dup_strm_U0_end_nblk_strm2_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal generateMsgSchedule_U0_w_strm_num_data_valid : STD_LOGIC_VECTOR (31 downto 0);
    signal generateMsgSchedule_U0_w_strm_fifo_cap : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal sha256Digest_256_U0_msgHashStrm_din : STD_LOGIC_VECTOR (255 downto 0);
    signal sha256Digest_256_U0_msgHashStrm_write : STD_LOGIC;
    signal sha256Digest_256_U0_eMsgHashStrm_din : STD_LOGIC_VECTOR (0 downto 0);
    signal sha256Digest_256_U0_eMsgHashStrm_write : STD_LOGIC;
    ...
    component test_hmac_sha256_dup_strm IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component test_hmac_sha256_generateMsgSchedule IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component test_hmac_sha256_sha256Digest_256_s IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
    ...
    component test_hmac_sha256_fifo_w32_d32_D IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component test_hmac_sha256_start_for_dup_strm_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component test_hmac_sha256_start_for_generateMsgSchedule_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component test_hmac_sha256_start_for_sha256Digest_256_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    dup_strm_U0 : component test_hmac_sha256_dup_strm
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        nblk_strm1_num_data_valid => dup_strm_U0_nblk_strm1_num_data_valid,
        nblk_strm1_fifo_cap => dup_strm_U0_nblk_strm1_fifo_cap,
        ...
        end_nblk_strm1_num_data_valid => dup_strm_U0_end_nblk_strm1_num_data_valid,
        end_nblk_strm1_fifo_cap => dup_strm_U0_end_nblk_strm1_fifo_cap,
        ...
        nblk_strm2_num_data_valid => dup_strm_U0_nblk_strm2_num_data_valid,
        nblk_strm2_fifo_cap => dup_strm_U0_nblk_strm2_fifo_cap,
        ...
        end_nblk_strm2_num_data_valid => dup_strm_U0_end_nblk_strm2_num_data_valid,
        end_nblk_strm2_fifo_cap => dup_strm_U0_end_nblk_strm2_fifo_cap);

    generateMsgSchedule_U0 : component test_hmac_sha256_generateMsgSchedule
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        w_strm_num_data_valid => generateMsgSchedule_U0_w_strm_num_data_valid,
        w_strm_fifo_cap => generateMsgSchedule_U0_w_strm_fifo_cap);

    sha256Digest_256_U0 : component test_hmac_sha256_sha256Digest_256_s
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
        ...
        msgHashStrm_din => sha256Digest_256_U0_msgHashStrm_din,
        msgHashStrm_full_n => hshStrm_full_n,
        msgHashStrm_write => sha256Digest_256_U0_msgHashStrm_write,
        msgHashStrm_num_data_valid => ap_const_lv3_0,
        msgHashStrm_fifo_cap => ap_const_lv3_0,
        eMsgHashStrm_din => sha256Digest_256_U0_eMsgHashStrm_din,
        eMsgHashStrm_full_n => eHshStrm_full_n,
        eMsgHashStrm_write => sha256Digest_256_U0_eMsgHashStrm_write,
    ...
    nblk_strm1_U : component test_hmac_sha256_fifo_w64_d32_D
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    end_nblk_strm1_U : component test_hmac_sha256_fifo_w1_d32_D
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    nblk_strm2_U : component test_hmac_sha256_fifo_w64_d32_D
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    end_nblk_strm2_U : component test_hmac_sha256_fifo_w1_d32_D
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    w_strm_U : component test_hmac_sha256_fifo_w32_d32_D
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_dup_strm_U0_U : component test_hmac_sha256_start_for_dup_strm_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_generateMsgSchedule_U0_U : component test_hmac_sha256_start_for_generateMsgSchedule_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_sha256Digest_256_U0_U : component test_hmac_sha256_start_for_sha256Digest_256_U0
    port map (
        clk => ap_clk,
        reset => ap_rst,
        if_read_ce => ap_const_logic_1,
    ...
    dup_strm_U0_end_nblk_strm1_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(end_nblk_strm1_fifo_cap),6))),32));
    dup_strm_U0_end_nblk_strm1_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(end_nblk_strm1_num_data_valid),6))),32));
    dup_strm_U0_end_nblk_strm2_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(end_nblk_strm2_fifo_cap),6))),32));
    dup_strm_U0_end_nblk_strm2_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(end_nblk_strm2_num_data_valid),6))),32));
    dup_strm_U0_nblk_strm1_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(nblk_strm1_fifo_cap),6))),32));
    dup_strm_U0_nblk_strm1_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(nblk_strm1_num_data_valid),6))),32));
    dup_strm_U0_nblk_strm2_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(nblk_strm2_fifo_cap),6))),32));
    dup_strm_U0_nblk_strm2_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(nblk_strm2_num_data_valid),6))),32));
    eHshStrm_din <= sha256Digest_256_U0_eMsgHashStrm_din;
    eHshStrm_write <= sha256Digest_256_U0_eMsgHashStrm_write;
    ...
    generateMsgSchedule_U0_w_strm_fifo_cap <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(w_strm_fifo_cap),6))),32));
    generateMsgSchedule_U0_w_strm_num_data_valid <= std_logic_vector(IEEE.numeric_std.resize(unsigned(std_logic_vector(IEEE.numeric_std.resize(unsigned(w_strm_num_data_valid),6))),32));
    hshStrm_din <= sha256Digest_256_U0_msgHashStrm_din;
    hshStrm_write <= sha256Digest_256_U0_msgHashStrm_write;
