...
reg   [62:0] i_5_fu_42;
wire   [62:0] grp_fu_80_p2;
wire    ap_block_pp0_stage1_11001;
wire    ap_loop_init;
reg   [62:0] ap_sig_allocacmp_i_5_load;
...
test_hmac_sha256_icmp_63ns_63ns_1_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 63 ),
    .din1_WIDTH( 63 ),
...
test_hmac_sha256_add_63ns_63ns_63_2_1 #(
    .ID( 1 ),
    .NUM_STAGE( 2 ),
    .din0_WIDTH( 63 ),
    .din1_WIDTH( 63 ),
    .dout_WIDTH( 63 ))
add_63ns_63ns_63_2_1_U11(
    .clk(ap_clk),
    .reset(ap_rst),
    .din0(ap_sig_allocacmp_i_5_load),
    .din1(63'd1),
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_subdone_grp0_done_reg) & (1'b0 == ap_block_pp0_stage0_11001_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        i_5_fu_42 <= 63'd0;
    end else if (((grp_fu_74_p2 == 1'd0) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
        i_5_fu_42 <= grp_fu_80_p2;
    end
end

always @ (*) begin
    if (((grp_fu_74_p2 == 1'd1) & (ap_enable_reg_pp0_iter0_reg == 1'b1) & (1'b0 == ap_block_pp0_stage1_subdone) & (1'b1 == ap_CS_fsm_pp0_stage1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_grp0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_i_5_load = 63'd0;
    end else begin
...
always @ (*) begin
    ap_block_state3_pp0_stage0_iter1_grp1 = ((mergeKipadStrm_full_n == 1'b0) | (msgStrm_empty_n == 1'b0));
end
